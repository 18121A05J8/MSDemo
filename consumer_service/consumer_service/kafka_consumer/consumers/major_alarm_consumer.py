...
logger = logging.getLogger("major_alarm_consumer")

class MajorAlarmConsumer(ConsumerInterface):
    def __init__(self):
        """Initialize the MajorAlarmConsumer with the topic and consumer configuration."""
        self.TOPIC = Constants.ALARM_MAJOR_TOPIC
