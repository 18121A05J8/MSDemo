...
from kafka.benchmarks.load_example import Consumer

from kafka_consumer.consumers.abstract_alarm_consumer import ConsumerInterface
from utils.constants import Constants

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("critical_alarm_consumer")

class CriticalAlarmConsumer(ConsumerInterface):
    def __init__(self):
        self.TOPIC = Constants.ALARM_CRITICAL_TOPIC
